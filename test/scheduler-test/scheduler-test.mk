...
EXTRA_DEPS := ${SOURCE_DIR}/scheduler-test.mk ${PROJECT_ROOT}/ldscripts/sections.ld ${PROJECT_ROOT}/ldscripts/memory.ld ${PROJECT_ROOT}/ldscripts/regions-sram.ld ${PROJECT_ROOT}/ldscripts/regions-flash.ld
EXTRA_CLEAN := ${INSTALL_ROOT}/scheduler-test.bin ${INSTALL_ROOT}/scheduler-test.elf ${INSTALL_ROOT}/scheduler-test.uf2
...
${INSTALL_ROOT}/scheduler-test.uf2: ${CURDIR}/scheduler-test.uf2
	@echo "INSTALLING ${@}"
	$(INSTALL) -m 660 -D ${<} ${@}

${INSTALL_ROOT}/scheduler-test.elf: ${CURDIR}/scheduler-test.elf
	@echo "INSTALLING ${@}"
	$(INSTALL) -m 660 -D ${<} ${@}

${INSTALL_ROOT}/scheduler-test.bin: ${CURDIR}/scheduler-test.bin
	@echo "INSTALLING ${@}"
	$(INSTALL) -m 660 -D ${<} ${@}
