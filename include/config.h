...
#define MOD_PRIORITY 101

#define SERVICES_PRIORITY 200
#define SERVICES_LOGGER_PRIORITY 201
#define SERVICE_EVENT_BUS_PRIORITY 202
#define SERVICES_SHELL_PRIORITY 203
...
#define LOGGER_STACK_SIZE 1024UL
#define LOGGER_BAUD_RATE 115200
#define LOGGER_HALF_DUPLEX_CHANNEL 1UL

#define EVENT_BUS_NUM_IDS 64UL
#define EVENT_BUS_NUM_HANDLERS 32UL
#define EVENT_BUS_QUEUE_DEPTH 8UL
...
#define LEG_MANAGER_PERIODIC_SWI 1UL
#define LEG_MANAGER_PERIODIC_CHANNEL 1UL
#define LEG_MANAGER_PERIODIC_RATE_HZ 100UL
