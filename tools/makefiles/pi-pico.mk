...
CPPFLAGS += -I${PROJECT_ROOT}/include/cmsis -D__BOARD="<board/${BOARD_TYPE}.h>" -D__HAL="<hal/${CHIP_TYPE}/hal-${CHIP_TYPE}.h>" -D__HARDWARE="<hardware/${CHIP_TYPE}/hardware-${CHIP_TYPE}.h>"
